      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="labs-client-card rounded-[22px] p-6">
            <div className="mb-6">
              <h3 className="text-xl font-bold text-white">Video Settings</h3>
              <p className="text-sm text-white/50 mt-1">Configure your AI-generated video</p>
            </div>
          ...
          <div className="labs-client-card rounded-[22px] p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-white/50 mt-1">Generated video will appear here</p>
            </div>
            ...
            <div className="w-full">
              {generatedVideo ? (
                ...
                <div className="flex items-center justify-center h-64 rounded-xl bg-white/5 border border-white/10">
                  <p className="text-white/40">No video generated yet</p>
                </div>
              )}
            </div>
          </div>
