      ...
      {needsFirstLastFrame && (
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-2">
            <span className="text-xs text-white/60">First:</span>
            {firstFrameImage ? (
              <div className="relative w-16 h-16">
                ...
                />
                <button onClick={() => setFirstFrameImage("")} className="absolute -top-1 -right-1 bg-red-500/80 rounded-full p-0.5"><X className="w-3 h-3 text-white" /></button>
              </div>
            ) : (
              <button onClick={() => firstFrameInputRef.current?.click()} className="w-16 h-16 border border-dashed border-white/20 rounded-lg flex items-center justify-center bg-white/5 hover:bg-white/10">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-xs text-white/60">Last:</span>
            {lastFrameImage ? (
              <div className="relative w-16 h-16">
                <img 
                  src={lastFrameImage} 
                ...
                />
                <button onClick={() => setLastFrameImage("")} className="absolute -top-1 -right-1 bg-red-500/80 rounded-full p-0.5"><X className="w-3 h-3 text-white" /></button>
              </div>
            ) : (
              <button onClick={() => lastFrameInputRef.current?.click()} className="w-16 h-16 border border-dashed border-white/20 rounded-lg flex items-center justify-center bg-white/5 hover:bg-white/10">
                <Upload className="h-4 w-4 text-white/60" />
              </button>
            )}
