  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 backdrop-blur-sm",
  {
    variants: {
      variant: {
        ...
        secondary: "border-border/30 bg-secondary/30 text-secondary-foreground hover:bg-secondary/50",
        destructive: "border-destructive/30 bg-destructive/10 text-destructive hover:bg-destructive/20",
        outline: "border-border/50 bg-background/30 text-foreground hover:bg-background/50",
      },
    },
    defaultVariants: {
      variant: "default",
