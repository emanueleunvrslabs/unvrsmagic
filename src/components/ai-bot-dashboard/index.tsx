...
export function AiBotDashboard() {
  const { botData, setBotData, botRunning, selectedStrategy, riskSettings, setRiskSettings, isRefreshing, toggleBotStatus, handleStrategyChange, handleRefresh } = useBotState();
